...
*/
  ...
  async getVisibility(repo) {
    ...
    console.log(`Debug: get return: ${JSON.stringify(results)}`)
    console.log(`Debug: get visibility: ${JSON.stringify(results.data.visibility)}`)
  ...
  async updateRepos(repo) {
    ...
    //Check for private.yml, public.yml, org internal.yml


    //Get visibility
    //debug
    console.log(`Debug: Checking Repo Visibility ${JSON.stringify(repo)}`)
    this.repoVisibility = this.repoVisibility || await this.getVisibility(repo)
    console.log(`Debug: Repo Visibility is ${JSON.stringify(this.repoVisibility)}`)

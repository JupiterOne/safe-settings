...
*/
  ...
  async getVisibility(repo) {
    ...
    return results.data.visibility
  }
  ...
  async updateRepos(repo) {
    ...
    //Check for visibility configs (private.yml, public.yml, org internal.yml)
    //this.visibilityConfigs = this.visibilityConfigs || await this.getVisibilityConfigs(this.github, repo, this.log)
    //Get visibility of the repo
    this.repoVisibility = this.repoVisibility || await this.getVisibility(repo)
    this.log.debug(`Repo ${repo.repo} has visibility ${this.repoVisibility}`)
...
Settings.PRIVATE_FILE_NAME = '.github/private.yml'
Settings.PUBLIC_FILE_NAME = '.github/public.yml'
Settings.INTERNAL_FILE_NAME = '.github/internal.yml'

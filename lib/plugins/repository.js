    ...
    if (this.security) {
      ...
      if (this.security?.enableVulnerabilityAlerts == true || this.security?.enableVulnerabilityAlerts == false) {    
          if(this.security.enableVulnerabilityAlerts == true){
            this.log(`Enabling Dependabot alerts for owner: ${JSON.stringify(repoData.data.owner.login)} and repo ${repoData.data.name}`);
          ...
          if(this.security.enableVulnerabilityAlerts == false){
            this.log(`Disabling Dependabot alerts for for owner: ${JSON.stringify(repoData.data.owner.login)} and repo ${repoData.data.name}`);

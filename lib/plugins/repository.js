...
module.exports = class Repository {
  ...
  updateCodeOwners(repoData) {
    if (this.codeowners) {
      this.log(`Found repo with codeowners settings ${JSON.stringify(this.codeowners)}`)
      if (repoData.data?.codeowners == true){
        this.log(`Updating repo with codeowners`)
        return
      } else {
